    ...
    485: function (e, t) {
        !(function () {
            ...
            !(function (e) {
                ...
                var r = { labels: ["Schedule", "Sent", "Draft", "Out on Vacation"], datasets: [{ data: [25, 18, 12, 9], backgroundColor: [], borderColor: settings.colors.white, hoverBorderColor: settings.colors.white }] };
