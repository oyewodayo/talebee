!(function (t) {
            ...
            if (!g || !v || ("replace" === t && (!u || !l || d)) || ("split" === t && !p)) {
                var y = /./[h],
                    x = r(
                        ...
                        ""[t],
                        function (t, e, r, n, o) {
                            return e.exec === a ? (g && !o ? { done: !0, value: y.call(e, r, n) } : { done: !0, value: t.call(r, e, n) }) : { done: !1 };
                        },
    ...
    16: function (t, e, r) {
        ...
        (t.exports = function (t, e, r, c) {
            var s,
                ...
                d = !!c && !!c.enumerable,
                p = !!c && !!c.noTargetGet;
            "function" == typeof r && ("string" != typeof e || i(r, "name") || o(r, "name", e), (s = l(r)).source || (s.source = f.join("string" == typeof e ? e : ""))),
                t !== n ? (u ? !p && t[e] && (d = !0) : delete t[e], d ? (t[e] = r) : o(t, e, r)) : d ? (t[e] = r) : a(e, r);
    ...
    36: function (t, e, r) {
        ...
        })("versions", []).push({ version: "3.8.1", mode: n ? "pure" : "global", copyright: "© 2020 Denis Pushkarev (zloirock.ru)" });
    },
    37: function (t, e, r) {
        var n = r(1);
        t.exports =
                    ...
                    (n =
                        "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length || 2 != "ab".split(/(?:ab)*/).length || 4 != ".".split(/(.?)(.?)/).length || ".".split(/()()/).length > 1 || "".split(/.?/).length
                            ? function (t, r) {
                                  ...
                                  for (
                                      var c, s, u, l = [], d = (t.ignoreCase ? "i" : "") + (t.multiline ? "m" : "") + (t.unicode ? "u" : "") + (t.sticky ? "y" : ""), h = 0, g = new RegExp(t.source, d + "g");
                                      (c = f.call(g, n)) && !((s = g.lastIndex) > h && (l.push(n.slice(h, c.index)), c.length > 1 && c.index < n.length && p.apply(l, c.slice(1)), (u = c[0].length), (h = s), l.length >= i));
                        ...
                        function (t, o) {
                            ...
                            for (var m = 0, S = 0, C = []; S < d.length; ) {
                                ...
                                if (null === w || (E = h(u(x.lastIndex + (g ? 0 : S)), d.length)) === m) S = s(d, S, v);
                                    ...
                                    for (var L = 1; L <= w.length - 1; L++) if ((C.push(w[L]), C.length === b)) return C;
                                    S = m = E;
                                }
                            }
            ...
            (u = function (t) {
                ...
                return (
                    u &&
                        ...
                        a.lastIndex > 0 && (!a.multiline || (a.multiline && "\n" !== t[a.lastIndex - 1])) && ((h = "(?: " + h + ")"), (v = " " + v), g++),
                        (r = new RegExp("^(?:" + h + ")", p))),
                    d && (r = new RegExp("^" + h + "$(?!\\s)", p)),
                    l && (e = a.lastIndex),
                    (n = c.call(u ? r : a, v)),
                    u ? (n ? ((n.input = n.input.slice(g)), (n[0] = n[0].slice(g)), (n.index = a.lastIndex), (a.lastIndex += n[0].length)) : (a.lastIndex = 0)) : l && n && (a.lastIndex = a.global ? n.index + n[0].length : e),
                    d &&
                        n &&
                        n.length > 1 &&
    ...
    946: function (t, e, r) {
        "use strict";
        r.r(e);
        r(32), r(14), r(11), r(85), r(47), r(107), r(52), r(45), r(73), r(82), r(13);
        var n = r(49),
            o = r.n(n),
            i = function t(e, r) {
            ...
            s = {
                ...
                elements: {
                    ...
                    line: { tension: 0.4, borderWidth: 3, borderColor: settings.colors.primary[500], backgroundColor: settings.colors.transparent, borderCapStyle: "rounded" },
                    rectangle: { backgroundColor: settings.colors.primary[500] },
                    arc: { backgroundColor: settings.colors.primary[500], borderColor: settings.colors.white, borderWidth: 4 },
                },
            ...
            f = function (t) {
                ...
                void 0 !== e.options.scales.yAxes[0] &&
                    ((e.options.scales.yAxes[0].gridLines = { color: r ? settings.colors.darkMode.border : settings.charts.gridLinesColor, zeroLineColor: r ? settings.colors.darkMode.border : settings.charts.zeroLineColor }),
                    (e.options.scales.yAxes[0].angleLines = { color: r ? settings.colors.darkMode.border : settings.charts.angleLinesColor })),
                    "doughnut" === e.config.type &&
                        ((e.data.datasets[0].borderColor = r ? settings.colors.darkMode.bodyBg : settings.colors.white), (e.data.datasets[0].hoverBorderColor = r ? settings.colors.darkMode.bodyBg : settings.colors.white));
                ...
                -1 !== e.config.type.toLowerCase().indexOf("bar") && (f = 0.2),
                    i.forEach(function (t, r) {
                        var n = a[r];
                        if (((u = u || -1 !== t.indexOf("gradient:")), -1 !== (t = t.replace(/gradient\:/gi, "")).indexOf(";")))
                            (t = t.split(";")),
                                (n = a[0].split(";")),
                    ...
                    e.update(),
                    $(t).data("chart-legend") && (document.querySelector($(t).data("chart-legend")).innerHTML = e.generateLegend());
            },
            d = function (t, e) {
            ...
            p = {
                ...
                create: function (t) {
                    ...
                    s && (r = Chart.helpers.merge({ scales: { yAxes: [{ display: !1 }], xAxes: [{ display: !1 }] } }, r)),
                        "area" === e && ((e = "line"), (r = Chart.helpers.merge({ elements: { line: { fill: "start" } } }, r))),
                        c && (r = Chart.helpers.merge({ elements: { point: { pointStyle: "circle", radius: 4, hoverRadius: 4, backgroundColor: settings.colors.white, borderColor: settings.colors.primary[500], borderWidth: 2 } } }, r)),
                        "radar" === e && (r = Chart.helpers.merge({ scale: { ticks: { display: !1, beginAtZero: !0, maxTicksLimit: 4 }, pointLabels: { fontSize: settings.charts.defaultFontSize } } }, r)),
                        "roundedBar" === e && (r = Chart.helpers.merge({ barRoundness: 1.2 }, r)),
                        ("doughnut" !== e && "radar" !== e) || (r = Chart.helpers.merge({ scales: { yAxes: { gridLines: { zeroLineWidth: 0 } } } }, r)),
                        (i.length || a.length) &&
                                        ...
                                        callbacks: {
                                            label: function (t, r) {
                                                ...
                                                return (
                                                    ...
                                                    1 < r.datasets.length && (c += '<span class="popover-body-label mr-auto">' + n + "</span>"),
                                                    c + '<span class="popover-body-value">'.concat(i).concat(o).concat(a, "</span>")
                                                );
                                            },
                                        },
                                    },
                        ...
                        u && (r = Chart.helpers.merge({ tooltips: { enabled: !1, custom: function () {} } }, r));
