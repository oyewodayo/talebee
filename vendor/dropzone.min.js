    ...
    Dropzone = (function () {
        ...
        function b(e, t) {
            ...
            return (
                ...
                !1 !== n.options.previewsContainer && (n.options.previewsContainer ? (n.previewsContainer = b.getElement(n.options.previewsContainer, "previewsContainer")) : (n.previewsContainer = n.element)),
                n.options.clickable && (!0 === n.options.clickable ? (n.clickableElements = [n.element]) : (n.clickableElements = b.getElements(n.options.clickable, "clickable"))),
                n.init(),
                n
            );
        }
                                ...
                                addedfile: function (t) {
                                    ...
                                    if ((this.element === this.previewsContainer && this.element.classList.add("dz-started"), this.previewsContainer)) {
                                        ...
                                        this.options.addRemoveLinks &&
                                            ((t._removeLink = b.createElement('<a class="dz-remove" href="javascript:undefined;" data-dz-remove>'.concat(this.options.dictRemoveFile, "</a>"))), t.previewElement.appendChild(t._removeLink));
                                        var l,
                                            s = function (e) {
                                                return (
                                                    e.preventDefault(),
                                                    ...
                                                    t.status === b.UPLOADING
                                                        ? b.confirm(n.options.dictCancelUploadConfirmation, function () {
                                                              return n.removeFile(t);
                                                          })
                                                        : n.options.dictRemoveFileConfirmation
                                                        ? b.confirm(n.options.dictRemoveFileConfirmation, function () {
                                                              return n.removeFile(t);
                                                          })
                                                        : n.removeFile(t)
                                                );
            ...
            _createClass(
                ...
                [
                        ...
                        value: function () {
                            ...
                            if (
                                ...
                                this.element.classList.contains("dropzone") &&
                                    ...
                                    this.element.appendChild(b.createElement('<div class="dz-default dz-message"><button class="dz-button" type="button">'.concat(this.options.dictDefaultMessage, "</button></div>"))),
                                this.clickableElements.length)
                            ) {
                                !(function r() {
                                    return (
                                        o.hiddenFileInput && o.hiddenFileInput.parentNode.removeChild(o.hiddenFileInput),
                                        (o.hiddenFileInput = document.createElement("input")),
                                        o.hiddenFileInput.setAttribute("type", "file"),
                                        (null === o.options.maxFiles || 1 < o.options.maxFiles) && o.hiddenFileInput.setAttribute("multiple", "multiple"),
                                        (o.hiddenFileInput.className = "dz-hidden-input"),
                                        null !== o.options.acceptedFiles && o.hiddenFileInput.setAttribute("accept", o.options.acceptedFiles),
                                        null !== o.options.capture && o.hiddenFileInput.setAttribute("capture", o.options.capture),
                                        ...
                                        b.getElement(o.options.hiddenInputContainer, "hiddenInputContainer").appendChild(o.hiddenFileInput),
                            ...
                            this.on("uploadprogress", function () {
                                ...
                                this.on("complete", function (e) {
                                    if (0 === o.getAddedFiles().length && 0 === o.getUploadingFiles().length && 0 === o.getQueuedFiles().length)
                                        return setTimeout(function () {
                        ...
                        value: function () {
                            ...
                            return (
                                "FORM" !== this.element.tagName
                                    ? (t = b.createElement('<form action="'.concat(this.options.url, '" enctype="multipart/form-data" method="').concat(this.options.method, '"></form>'))).appendChild(i)
                                    ...
                                    for (n.s(); !(e = n.n()).done; ) {
                                        ...
                                        null != r.webkitGetAsEntry && (i = r.webkitGetAsEntry())
                                            ? i.isFile
                                                ...
                                                : t.push(void 0)
                                            : null != r.getAsFile && (null == r.kind || "file" === r.kind)
                                            ? t.push(a.addFile(r.getAsFile()))
                                            : t.push(void 0);
                                    }
                                } catch (e) {
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            var n = this;
                            (t.upload = { uuid: b.uuidv4(), progress: 0, total: t.size, bytesSent: 0, filename: this._renameFile(t) }),
                                this.files.push(t),
                                (t.status = b.ADDED),
                    ...
                    },
                    {
                        ...
                        value: function (o, a, l, s, t, u, e) {
                            ...
                            return (
                                e && (d.crossOrigin = e),
                                (t = "from-image" != getComputedStyle(document.body).imageOrientation && t),
                                (d.onload = function () {
                                    var e = function (e) {
                                        return e(1);
                                    };
                                        ...
                                        e(function (e) {
                                            ...
                                            switch (((n.width = t.trgWidth), (n.height = t.trgHeight), 4 < e && ((n.width = t.trgHeight), (n.height = t.trgWidth)), e)) {
                                                ...
                                                case 6:
                                                    ...
                                                    break;
                                                case 7:
                                                    i.rotate(0.5 * Math.PI), i.translate(n.height, -n.width), i.scale(-1, 1);
                                                    break;
                                                case 8:
                        ...
                        value: function (t, e) {
                            ...
                            if (this.options.params) {
                                ...
                                for (var h in ("function" == typeof p && (p = p.call(this, t, r, t[0].upload.chunked ? this._getChunk(t[0], r) : null)), p)) {
                                    var f = p[h];
                                    if (Array.isArray(f)) for (var m = 0; m < f.length; m++) d.append(h, f[m]);
                                    else d.append(h, f);
                                }
                            }
                            var v,
        ...
        return (
            _createClass(e, null, [
                ...
                },
                {
                    ...
                    value: function (e) {
                        for (
                            var t = "", n = void 0, i = void 0, r = "", o = void 0, a = void 0, l = void 0, s = "", u = 0;
                            (o = (n = e[u++]) >> 2),
                                (a = ((3 & n) << 4) | ((i = e[u++]) >> 4)),
                                (l = ((15 & i) << 2) | ((r = e[u++]) >> 6)),
                                (s = 63 & r),
                ...
                },
                {
                    ...
                    value: function (e) {
                        ...
                        for (
                            ...
                            (t = (this.KEY_STR.indexOf(e.charAt(l++)) << 2) | ((r = this.KEY_STR.indexOf(e.charAt(l++))) >> 4)),
